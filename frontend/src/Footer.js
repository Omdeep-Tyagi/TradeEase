  ...
  return (
   <footer style={{backgroundColor:"rgb(250,250,250)"}}>
      ...
      <div className="row mt-5">
        <div className="col">
          <img src="media/images/logo.svg" style={{ width: "50%" }} className="mb-4"></img>
          <p className="text-muted">&copy; 2010 - 2024, Zerodha Broking Ltd. <br/>All rights reserved.</p>
        </div>
        <div className="col">
          <p className="paraDecora">Company</p>
          <a href="" className="Decora" >About</a>
          <br></br>
          <a href="" className="Decora">Products</a>
          <br></br>
          <a href="" className="Decora">Pricing</a>
          <br></br>
          <a href="" className="Decora">Referral programme</a>
          <br></br>
          <a href="" className="Decora">Careers</a>
          <br></br>
          <a href="" className="Decora">Zerodha.tech</a>
          <br></br>
          <a href="" className="Decora">Press & media</a>
          <br></br>
          <a href="" className="Decora">Zerodha Cares (CSR)</a>
        </div>
        <div className="col">
          <p className="paraDecora">Support</p>
          <a href="" className="Decora">Contact us</a>
          <br></br>
          <a href="" className="Decora">Support portal</a>
          <br></br>
          <a href="" className="Decora">Z-Connect blog</a>
          <br></br>
          <a href="" className="Decora">Downloads & resources</a>
          <br></br>
          <a href="" className="Decora">Videos</a>
          <br></br>
        </div>
        <div className="col">
          <p className="paraDecora">Account</p>
          <a href="" className="Decora">Open an account</a>
          <br></br>
          <a href="" className="Decora">Fund transfer</a>
          <br></br>
        </div>
      </div>
