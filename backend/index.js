...
const cookieParser = require("cookie-parser");//The cookie-parser middleware parses cookies attached to the client request object. This middleware populates the req.cookies object with the parsed cookies.
...
//one time setup for adding dummy data
